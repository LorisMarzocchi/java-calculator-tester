...
//    }
    ...
    void add(){
        float x = Calculator.add(10, 1);
        assertEquals(11, x,"addizione corretta");
//        assertNotEquals(12, x, "addizione non corretta");
    ...
    void subtract() {
        assertEquals(1.0f, Calculator.subtract(3.0f, 2.0f), "Sottrazione di due numeri");
    }

    @Test
    @DisplayName("controllo moltiplicazione")
    void multiply() {
        assertEquals(6.0f, Calculator.multiply(3.0f, 2.0f), "moltiplicazione tra 2 numeri");
    }
...
//    @DisplayName("throws IllegalArgumentException quando chiede di dividere per 0")
    ...
    void testDivideByZero() {
        ...
        assertThrows(ArithmeticException.class, () -> Calculator.divide(1.0f, 0.0f), "impossibile dividere per 0");
